...
const PROJECT_CLASSES = {
  ...
  grid: "grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10",
  card: "group relative flex min-h-[230px] flex-col overflow-visible rounded-md border border-slate-200 bg-white/70 p-5 sm:p-6",
  stripe:
    "pointer-events-none absolute bottom-5 -left-3 top-5 w-[4px] scale-y-75 rounded-full bg-emerald-200/90 opacity-0",
  header: "flex items-start justify-between gap-3",
  title: "text-[1.05rem] font-medium text-slate-900 sm:text-[1.2rem]",
  ...
  tag: "rounded-full bg-slate-100 px-3 py-1 text-[0.7rem] text-slate-700",
} as const;
